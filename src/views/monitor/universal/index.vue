  ...
  <div class="app-container">
    <div class="filter-container clearfix">
      ...
      <div class="filter-container-right clearfix">
        <router-link :to="{ name: 'MonitorUniversalCreate' }">
    ...
    >
      ...
      >
        <template #default="{ row }">
          <router-link :to="{ name: 'MonitorUniversalEdit', params: { taskId: row.id }}">
...
<script>
import { tasks, deleteTask, startTask, stopTask } from '@/api/monitor/universal'
